...
public class Tester extends Menu {
    public static void main(String[] args) {
        // Initialize the social media network
        SocialMediaNetwork network = new SocialMediaNetwork();

        // Add users to the network
        User user1 = new User(1, "Alice", 25, "New York", "Google", "Test1234");
        User user2 = new User(2, "Bob", 30, "San Francisco", "Apple", "TestPoop");
        User user3 = new User(3, "Charlie", 35, "London", "Facebook", "Password123");
        ...
        User user4 = new User(4, "David", 40, "Sydney", "Amazon", "Awooga");
